...
type RetryableFuncWithData func() (interface{}, error)
...
func RetryWithData(retryableFunc RetryableFuncWithData, opts ...RetryOption) (interface{}, error) {
	var n uint
	var emptyT interface{}
